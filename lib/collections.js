...
Schemas.timeLog = new SimpleSchema({
    ...
    'totalMissingHours': {
        ...
        optional: true,
        autoValue: function (a, b) {
            var startTime = this.siblingField('lastSeenDateTime');
            var endTime = this.siblingField('subjectLocatedDateTime');
    ...
    'totalSearchHours': {
        ...
        optional: true,
        autoValue: function (a, b) {
            var startTime = this.siblingField('SARNotifiedDatetime');
            var endTime = this.siblingField('subjectLocatedDateTime');
            if (startTime.isSet && endTime.isSet) {
                startTime = startTime
                    .value;
