/*L.Control.Measure = L.Control.extend({
	...
	onAdd: function (map) {
		...
		this._createButton('&#8674;', 'Measure', 'leaflet-control-measure leaflet-bar-part leaflet-bar-part-top-and-bottom fa fa-arrows-h', container, this._toggleMeasure, this);
...
L.Control.MeasureControl = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        this.options.handler.metric = this.options.metric; 
